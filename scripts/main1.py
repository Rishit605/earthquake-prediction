...
from eq_prediction.model import EarthquakeModel, Early_Stopping, ModelCheckPoint
...
from eq_prediction.prediction.inference import (
    future_forecast,
...
def training():
    ...
    # Callbacks
    model_checkpoint = ModelCheckPoint(file_path=str(MODEL_PATH), verbose=True)
...
async def predict():
    try:
        ...
        expected_outputs = set(target_column)
