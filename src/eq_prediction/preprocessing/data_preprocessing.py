...
from eq_prediction.helpers.utils import find_mean, find_variance

### DATA TRANSFORMATION
# Data Preparation
class EQDataLoader:
    def __init__(self, Saved: bool = True, fill_save: bool = False) -> None:
        from eq_prediction.preprocessing.data_eng_test import data_eng_test, data_eng_test_incremental
    ...
    def _load_raw_data(saved: bool):
        try:
            from eq_prediction.helpers.sql_data_handler import fetch_raw_data, fetch_table
            from eq_prediction.helpers.datapi import data_geo_ready
    ...
    def _load_engineered_data(file_name: str):
        ...
        try:
            from eq_prediction.helpers.sql_data_handler import fetch_engineered_data
